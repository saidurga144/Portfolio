...
const projects = [
  {
    ...
    description:
      "A real-time URL threat detection tool that analyses links for phishing, malware, and suspicious patterns using multiple security APIs.",
  ...
  },
  {
    ...
    description:
      "An ML-powered crop recommendation and yield prediction platform that helps farmers make data-driven agricultural decisions.",
  ...
  },
  {
    ...
    description:
      "A psychology-backed career guidance platform that maps personality traits and skills to ideal career paths and growth roadmaps.",
...
function ProjectCard({
  ...
  // Microlink screenshot API — free, no auth needed, returns a real screenshot
    ...
    >
      ...
      <div className="flex items-center justify-between px-5 py-4"
        ...
        <div className="flex items-center gap-3">
          <ThemedIcon size={34} accentColor={p.accent}>
            {projectIcons[p.icon]}
          </ThemedIcon>
          <div>
      ...
      <div className="flex items-center gap-2 px-4 py-2"
        style={{ background: "var(--color-surface-2, var(--color-bg))", borderBottom: "1px solid var(--color-border)" }}>
      ...
      <a
        ...
        className="relative block overflow-hidden group/preview"
        style={{ height: "220px" }}
      >
        {!imgError ? (
          <img
          ...
          /* Fallback when screenshot API fails */
          <div
        ...
        {loading && !error && (
          <div className="absolute inset-0 flex items-center justify-center z-10"
            ...
            <div className="flex flex-col items-center gap-3">
              <Loader2 size={24} className="animate-spin" style={{ color: p.accent }} />
              <p className="text-xs" style={{ color: "var(--color-text-3)", fontFamily: "var(--font-dm-sans)" }}>
                Loading preview…
              </p>
            </div>
          </div>
        ...
        {error && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 z-10"
            ...
            <a href={p.url} target="_blank" rel="noopener noreferrer"
              ...
              style={{ background: `${p.accent}15`, border: `1px solid ${p.accent}30`,
                color: p.accent, fontFamily: "var(--font-dm-sans)" }}>
              Open Live Site →
            </a>
          </div>
        )}
