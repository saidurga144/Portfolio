      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white px-4">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto">
          ...
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-300 bg-clip-text text-transparent animate-fade-in-up animation-delay-300">
              {headline.line1}
            </h1>
          </div>
          ...
          <div className="animate-fade-in-up animation-delay-500">
            <p className="text-xl md:text-2xl text-orange-300/90 font-medium">
              {headline.line2}
            </p>
          </div>
