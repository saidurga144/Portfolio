...
export function ParallaxText({ children, baseVelocity = 100, className, style }: ParallaxProps) {
  ...
  return (
    <div className="overflow-hidden -tracking-wider leading-[0.8] m-0 whitespace-nowrap flex flex-nowrap mt-[1px]">
      <motion.div 
        style={{ x, ...style }}
        className={cn(
          "font-semibold uppercase text-6xl flex whitespace-nowrap flex-nowrap will-change-transform",
          className
        )}
      >
